...
function beam_search(
    ...
    while !isempty(beam_nodes)
        ...
        for node in beam_nodes
            ...
            keep_best_N_solutions!(best_n, completed_solutions, best_n_helper, N) # TODO: this could be more efficient with better datastructure
        end
    ...
    ranked_final_candidates = keep_best_unique(vcat(best_n, [fallback]), max(1, N))
